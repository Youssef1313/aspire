...
public class HealthStatusTests
{
    ...
    [TestMethod]
    [DataRow(StartingState, null, null)]
    [DataRow(StartingState, null, new string[]{})]
    [DataRow(StartingState, null, new string?[]{null})]
    ...
    [DataRow(RunningState, HealthStatus.Healthy, new string[]{})]
    [DataRow(RunningState, HealthStatus.Healthy, new string?[] {"Healthy"})]
    [DataRow(RunningState, HealthStatus.Unhealthy, new string?[] {null})]
    [DataRow(RunningState, HealthStatus.Degraded, new string?[] {"Healthy", "Degraded"})]
