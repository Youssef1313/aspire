...
public class AnsiParserTests
{
    ...
    [DataRow("")]
    [DataRow(" ")]
    [DataRow("This is some text without any codes")]
    [DataRow("This is some text \x1C with an invalid code")]
    public void ConvertToHtml_ReturnsInputUnchangedIfNoCodesPresent(string input)
    {
        ...
        Assert.AreEqual(expectedOutput, result.ConvertedText);
    }
    ...
    [DataRow("\x1B[?25l", "")]
    [DataRow("\x1B[23m", "")]
    [DataRow("\x1B[2m\x1B[23m", "")]
    [DataRow("Real Text Before\x1B[2m\x1B[23m", "Real Text Before")]
    [DataRow("\x1B[2m\x1B[23mReal Text After", "Real Text After")]
    [DataRow("\x1B[2mReal Text Between\x1B[23m", "Real Text Between")]
    [DataRow("Real Text Before\x1B[2mReal Text Between\x1B[23mReal Text After", "Real Text BeforeReal Text BetweenReal Text After")]
    public void ConvertToHtml_IgnoresUnsupportedButValidCodes(string input, string expectedOutput)
    {
        var result = AnsiParser.ConvertToHtml(input);

        Assert.AreEqual(expectedOutput, result.ConvertedText);
        Assert.AreEqual(default, result.ResidualState);
    }

    [TestMethod]
    [DataRow("\x1b]9;4;3;\x1b\\", "")]
    [DataRow("\x1b]9;4;3;\x07", "")]
    [DataRow("Real Text Before\x1b]9;4;3;\x1b\\", "Real Text Before")]
    [DataRow("\x1b]9;4;3;\x1b\\Real Text After", "Real Text After")]
    [DataRow("\u001b]9;4;3;\u001b\\Real Text Between\u001b]9;4;3;\u001b\\", "Real Text Between")]
    ...
    public void ConvertToHtml_ColorOpenedButNotClosed_AutoClosedWithResidualState()
    {
        ...
        Assert.AreEqual(expectedOutput, result.ConvertedText);
        Assert.AreEqual(expectedResidualState, result.ResidualState);
    }
    ...
    public void ConvertToHtml_FormattingAcrossLines()
    {
        ...
        Assert.AreEqual(expectedOutput1, result1.ConvertedText);
        Assert.AreEqual(new AnsiParser.ParserState() { ForegroundColor = ConsoleColor.Green }, result1.ResidualState);
        Assert.AreEqual(expectedOutput2, result2.ConvertedText);
        Assert.AreEqual(default, result2.ResidualState);
    }
    ...
    public void ConvertToHtml_OverlappingFormattingAcrossLines()
    {
        ...
        Assert.AreEqual(expectedOutput1, result1.ConvertedText);
        Assert.AreEqual(new AnsiParser.ParserState() { ForegroundColor = ConsoleColor.Green, BackgroundColor = ConsoleColor.Green }, result1.ResidualState);
        Assert.AreEqual(expectedOutput2, result2.ConvertedText);
        Assert.AreEqual(default, result2.ResidualState);
    }

    [TestMethod]
    [DataRow("\x1B[30mBlack\x1B[39m", "<span class=\"ansi-fg-black\">Black</span>")]
    [DataRow("\x1B[31mRed\x1B[39m", "<span class=\"ansi-fg-red\">Red</span>")]
    [DataRow("\x1B[32mGreen\x1B[39m", "<span class=\"ansi-fg-green\">Green</span>")]
    [DataRow("\x1B[33mYellow\x1B[39m", "<span class=\"ansi-fg-yellow\">Yellow</span>")]
    [DataRow("\x1B[34mBlue\x1B[39m", "<span class=\"ansi-fg-blue\">Blue</span>")]
    [DataRow("\x1B[35mMagenta\x1B[39m", "<span class=\"ansi-fg-magenta\">Magenta</span>")]
    [DataRow("\x1B[36mCyan\x1B[39m", "<span class=\"ansi-fg-cyan\">Cyan</span>")]
    [DataRow("\x1B[37mWhite\x1B[39m", "<span class=\"ansi-fg-white\">White</span>")]
    [DataRow("\x1B[1m\x1B[30mBright Black\x1B[22m\x1B[39m", "<span class=\"ansi-fg-brightblack\">Bright Black</span>")]
    [DataRow("\x1B[1m\x1B[31mBright Red\x1b[22m\x1B[39m", "<span class=\"ansi-fg-brightred\">Bright Red</span>")]
    [DataRow("\x1B[1m\x1B[32mBright Green\x1B[22m\x1B[39m", "<span class=\"ansi-fg-brightgreen\">Bright Green</span>")]
    [DataRow("\x1B[1m\x1B[33mBright Yellow\x1B[22m\x1B[39m", "<span class=\"ansi-fg-brightyellow\">Bright Yellow</span>")]
    [DataRow("\x1B[1m\x1B[34mBright Blue\x1B[22m\x1B[39m", "<span class=\"ansi-fg-brightblue\">Bright Blue</span>")]
    [DataRow("\x1B[1m\x1B[35mBright Magenta\x1B[22m\x1B[39m", "<span class=\"ansi-fg-brightmagenta\">Bright Magenta</span>")]
    [DataRow("\x1B[1m\x1B[36mBright Cyan\x1B[22m\x1B[39m", "<span class=\"ansi-fg-brightcyan\">Bright Cyan</span>")]
    [DataRow("\x1B[1m\x1B[37mBright White\x1B[22m\x1B[39m", "<span class=\"ansi-fg-brightwhite\">Bright White</span>")]
    ...
    [TestMethod]
    [DataRow("\x1B[40mBlack\x1B[49m", "<span class=\"ansi-bg-black\">Black</span>")]
    [DataRow("\x1B[41mRed\x1B[49m", "<span class=\"ansi-bg-red\">Red</span>")]
    [DataRow("\x1B[42mGreen\x1B[49m", "<span class=\"ansi-bg-green\">Green</span>")]
    [DataRow("\x1B[43mYellow\x1B[49m", "<span class=\"ansi-bg-yellow\">Yellow</span>")]
    [DataRow("\x1B[44mBlue\x1B[49m", "<span class=\"ansi-bg-blue\">Blue</span>")]
    [DataRow("\x1B[45mMagenta\x1B[49m", "<span class=\"ansi-bg-magenta\">Magenta</span>")]
    [DataRow("\x1B[46mCyan\x1B[49m", "<span class=\"ansi-bg-cyan\">Cyan</span>")]
    [DataRow("\x1B[47mWhite\x1B[49m", "<span class=\"ansi-bg-white\">White</span>")]
    ...
    [TestMethod]
    [DataRow("\x1B[38;5;100mtext", "<span style=\"color: #878700\">text</span>")]
    [DataRow("\x1B[38;5;200mtext", "<span style=\"color: #ff00d7\">text</span>")]
    [DataRow("\x1B[38;5;245mtext", "<span style=\"color: #8a8a8a\">text</span>")]
    [DataRow("\x1B[38;5;231mtext", "<span style=\"color: #ffffff\">text</span>")]
    [DataRow("\x1B[38;5;255mtext", "<span style=\"color: #eeeeee\">text</span>")]
    [DataRow("\x1B[38;5;0mtext", "<span style=\"color: #000000\">text</span>")]
    ...
    [TestMethod]
    [DataRow("\x1B[48;5;100mtext", "<span style=\"background-color: #878700\">text</span>")]
    [DataRow("\x1B[48;5;200mtext", "<span style=\"background-color: #ff00d7\">text</span>")]
    [DataRow("\x1B[48;5;245mtext", "<span style=\"background-color: #8a8a8a\">text</span>")]
    [DataRow("\x1B[48;5;231mtext", "<span style=\"background-color: #ffffff\">text</span>")]
    [DataRow("\x1B[48;5;255mtext", "<span style=\"background-color: #eeeeee\">text</span>")]
    [DataRow("\x1B[48;5;0mtext", "<span style=\"background-color: #000000\">text</span>")]
    ...
    [TestMethod]
    [DataRow("\x1B[4;38;5;100mtext", "<span class=\"ansi-underline\" style=\"color: #878700\">text</span>")]
    [DataRow("\x1B[4;9;38;5;100mtext", "<span class=\"ansi-underline ansi-strikethrough\" style=\"color: #878700\">text</span>")]
    ...
    [TestMethod]
    [DataRow("\x1B[3mtext", "<span class=\"ansi-italic\">text</span>")]
    [DataRow("\x1B[4mtext", "<span class=\"ansi-underline\">text</span>")]
    [DataRow("\x1B[9mtext", "<span class=\"ansi-strikethrough\">text</span>")]
    ...
    [DataRow(" ")]
    [DataRow("This is some text without any codes")]
    [DataRow("This is some text \x1B with an invalid code")]
    [DataRow("\x1B This is some text that starts with an invalid code")]
    [DataRow("This is some text that ends with an invalid code \x1B")]
    [DataRow("\x1B Multiple \x1B invalid \x1B\x1B codes \x1B")]
    [DataRow("!\x1B!\x1B!\x1B\x1B!!\x1B!")]
    ...
    [TestMethod]
    [DataRow("\x1B[31mError:\x1B[0m \x1B[1m\x1B[4mFile not found\x1B[0m in directory \x1B[34m/home/user/docs\x1B[0m", "Error: File not found in directory /home/user/docs")]
    [DataRow("\x1B[32mSuccess:\x1B[0m \x1B[1m\x1B[3mOperation completed successfully\x1B[0m", "Success: Operation completed successfully")]
    [DataRow("\x1B[33mWarning:\x1B[0m \x1B[4mLow disk space\x1B[0m on drive \x1B[35mC:\x1B[0m", "Warning: Low disk space on drive C:")]
    [DataRow("\x1B[36mInfo:\x1B[0m \x1B[1m\x1B[3mBackup completed\x1B[0m at \x1B[32m12:00 PM\x1B[0m", "Info: Backup completed at 12:00 PM")]
    [DataRow("\x1B[36m", "")]
    [DataRow("Ends \x1B[36m", "Ends ")]
    [DataRow("\x1B[36m Starts", " Starts")]
    [DataRow("\x1B[36m\x1B[36m", "")]
    [DataRow("1\x1B[36m2\x1B[36m3", "123")]
